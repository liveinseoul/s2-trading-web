...
const STEPS = [
  {
    ...
    d: "검증된 S2 룰(7년 백테스트 Calmar ~1.1, 시초 매도·추가매수 보수적 가정 반영)을 시세에 적용해 모델 포트폴리오를 추적합니다. 직장에서 일하는 동안 시스템이 대신 봅니다.",
  },
  {
    n: "2",
    t: "15:10 — 동시호가 직전 알림",
    ...
    <div className="pb-16 pt-8 lg:pt-12">
      ...
      <section className="mb-20 sm:mb-28">
        ...
        <p className="mb-8 text-xs leading-relaxed text-muted sm:text-sm">
          7년 정직(무비용·0버퍼 · 시초 매도·추가매수일 매도 보류 가정) 기준. 12년 시점-정확(상폐 포함, 생존편향 제거) Calmar ~0.7
